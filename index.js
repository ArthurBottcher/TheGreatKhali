...
client.on("guildMemberAdd", async (member) => { 
  ...
  let emoji = await member.guild.emojis.cache.find(emoji => emoji.name === ":golimAmor:");
  if (guild != member.guild) {
    ...
    .setDescription(`**${member.user}**, bem-vindo(a) ao servidor **${guild.name}**! Atualmente estamos com **${member.guild.memberCount} membros*   divirta-se conosco! :golimAmor:`)
